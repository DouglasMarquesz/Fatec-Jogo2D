...
type
  ...
  public
    ...
    function CheckHit(OnFinish: TProc=nil): Double;
  End;
...
function TRectangleHelper.CheckHit(OnFinish: TProc): Double;
var
...
// Opacidade
      TAnimation.Animate(Self, 'Opacity', 0.4, ANITIME)
        .AnimeType(TAnimationType.Out)
        .AnimeInterpolation(TInterpolationType.Quadratic)
        .Start;
// Largura
      TAnimation.Animate(Self, 'Width', Width*2+5, ANITIME)
        .AnimeType(TAnimationType.Out)
        .AnimeInterpolation(TInterpolationType.Quadratic)
        .Start;
// Posição
...
// Opacidade
      TAnimation.Animate(Self, 'Opacity', 0.4, ANITIME)
        ...
        .Start;
// Altura
      TAnimation.Animate(Self, 'Height', Height*2+5, ANITIME)
        .AnimeType(TAnimationType.Out)
        .AnimeInterpolation(TInterpolationType.Quadratic)
        .Start;
// Posição
